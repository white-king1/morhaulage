            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <h3>TOTAL INVEST TRANSFERS</h3>
                    </div>
                    <div class="col-12 col-sm-6">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">
                                    <i data-feather="home"></i></a></li>
                            <li class="breadcrumb-item">TOTAL INVEST TRANSFER</li>
                ...
                <div class="col-xxl-10 col-md-10 mx-auto box-col-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="theme-form mega-form" action="{{ route('totalinvest.trans') }}"
                                        method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label" for="exampleFormControlSelect9">CHARGE</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="referral_link" type="text"
                                                placeholder="Referral Link" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="exampleFormControlSelect9">AMOUNT(USD)</label>
                                            <input class="form-control" name="transfer_amount" type="text"
