        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h3>ETHEREUM(ERC20) WITHDRAW PREVIEW</h3>
                </div>
                <div class="col-12 col-sm-6">
                    <ol class="breadcrumb">
            ...
            <div class="col-xxl-10 col-md-10 mx-auto box-col-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form class="theme-form mega-form" action="{{route('posteth.withdraw')}}" method="POST">
                                         @csrf
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <input class="form-control" name="crypto_currency" type="text" placeholder="ETHEREUM (ERC20)"
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="exampleFormControlSelect9">ETHEREUM (ERC20) WALLET ADDRESS</label>
                                        <input class="form-control" name="wallet_address" type="text" placeholder="TYPE IN YOUR ETH WALLET ADDRESS"
                                            required>
                                    </div>
                                    <div class="mb-3">
