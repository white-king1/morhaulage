                                    ...
                                    <div class="media">
                                        <div class="media-body">
                                            <div class="greeting-user">
                                                ...
                                                <p>Welcome to your Admin dashboard!</p><a
                                                    class="btn btn-outline-white_color" href="blog-single.html">Get
                                                    Started<i class="icon-arrow-right"> </i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="cartoon-img"><img class="img-fluid"
                                            src="http://admin.pixelstrap.com/zeta/assets/images/images.svg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-bordernone">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-light-theme-light font-theme-light">1
                                                            day ago</span></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="badge badge-light-theme-light font-theme-light">2
                                                            weeks ago</span></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td><span class="badge badge-light-theme-light font-theme-light">3
                                                            day ago</span></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body"><a href="user-profile.html">
                                                                ...
                                                                <p>Comment on <span class="font-primary">Vegetarian food
                                                                        fest</span></p>
                                                                <div class="activity-msg"> <span class="activity-msg-box">
                                                                        Again this was our mistake, we are truly sorry
                                                                        for not adhering to a strictly non animal
                                                                        product event.</span></div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td> <span class="badge badge-light-theme-light font-theme-light">10
                                                            jul 2020</span></td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                                ...
                                                                <div class="my-gallery" itemscope="">
                                                                    <div class="row gallery">
                                                                        ...
                                                                        <figure class="inner-img ms-3"
                                                                            ...
                                                                            <figcaption itemprop="caption description">
                                                                                Photos 2
                                                    <td> <span class="badge badge-light-theme-light font-theme-light">22
                                                            Jun 2020</span></td>
                                                    </figcaption>
                                                    </figure>
                                    </div>
