                        ...
                        <div class="card-header card-no-border">
                            <div class="media media-dashboard">
                                <div class="media-body">
                                    <center>
                                        <h2 class="mb-0">SUCCESSFUL PAYMENT <i  data-feather="thumbs-up" style="color:green;" ></i> </h2>
                                    </center>
                                    <br>
                                    <h4>CONGRATULATIONS YOUR DEPOSIT WAS SUCCESSFUL,KINDLY REFER MORE PEOPLE TO GAIN A REFERRAL BONUS</h4>
                                </div>
