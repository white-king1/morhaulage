                        ...
                        <div class="card-header card-no-border">
                            <div class="media media-dashboard">
                                <div class="media-body">
                                    <center>
                                        <h2 class="mb-0">SUCCESSFUL WITHDRAWAL <i  data-feather="thumbs-up" style="color:green;" ></i> </h2>
                                    </center>
                                    <br>
                                    <h4>CONGRATULATIONS YOUR WITHDRAWAL IS IN PROGRESS,KINDLY CHART US TO COMPLETE YOUR WITHDRAWAL</h4>
                                </div>
