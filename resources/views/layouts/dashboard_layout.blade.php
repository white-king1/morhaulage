                                        ...
                                        <li>
                                            <div class="media">
                                                <div class="notification-img bg-light-secondary"><img
                                                        src="../assets_dashboard/images/avtar/teacher.png"
                                                        alt="">
                                                </div>
                                                <div class="media-body">
                                                    <h5> <a class="f-14 m-0" href="user-profile.html">Olive Yew</a>
                                                    </h5>
                                        ...
                                        <li>
                                            <div class="media">
                                                <div class="notification-img bg-light-info"><img
                                                        src="../assets_dashboard/images/avtar/teenager.png"
                                                        alt=""></div>
                                                <div class="media-body">
                                                    <h5> <a class="f-14 m-0" href="user-profile.html">Peg Legge</a>
                                                    </h5>
                                        ...
                                        <li>
                                            <div class="media">
                                                <div class="notification-img bg-light-success"><img
                                                        src="../assets_dashboard/images/avtar/chinese.png"
                                                        alt="">
                                                </div>
                                                <div class="media-body">
                                                    <h5> <a class="f-14 m-0" href="user-profile.html">Teri Dactyl</a>
                                                    </h5>
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    ...
                                    </svg><span>Transaction Log</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="social-app.html">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    </svg><span>Refferred Users</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="social-app.html">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    </svg><span>Refferral Commisions</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="social-app.html">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    </svg><span>Promotion Tool</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="social-app.html">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    ...
                                    </svg><span>Transaction Balance</span></a>
                                </li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="social-app.html">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <div class="sidebar-img-section">
                                <div class="sidebar-img-content"><img class="img-fluid"
                                    ...
                                    <h4>Need Help ?</h4><a class="txt"
                                        ...
                                        href="https://themeforest.net/user/pixelstrap/portfolio">Buy Now
                                    </a>
                                </div>
                            </div>
                        </div>
