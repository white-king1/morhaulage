...
<head>
    ...
    <link rel="icon" href="../admin_assets_dashboard/images/logo/favicon-icon.png" type="image/x-icon">
    <link rel="shortcut icon" href="../admin_assets_dashboard/images/logo/favicon-icon.png" type="image/x-icon">
...
<body>
                            ...
                            <li class="onhover-dropdown">
                                ...
                                <div class="onhover-show-div notification-dropdown">
                                    <div class="dropdown-title">
                                        <h3>Notification</h3><a class="f-right" href="cart.html"> <i
                                                data-feather="bell">
                                            </i></a>
                                    </div>
                                    <ul class="custom-scrollbar">
                                        ...
                                        <li class="p-0"><a class="btn btn-primary" href="#">Check all</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    <label class="badge badge-light-primary"></label><a
                                        class="sidebar-link sidebar-title" href="{{ route('admin') }}">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                                <g>
                                ...
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="{{ route('all.deposits') }}">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                                <g>
                                                    <path d="M8.44019 12L10.8142 14.373L15.5602 9.62695"
                                                        stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                                                        stroke-linejoin="round"></path>
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="sidebar-img-section">
                                <div class="sidebar-img-content"><img class="img-fluid"
                                        src="../admin_assets_dashboard/images/side-bar.png" alt="">
                                    <h4>Need Help ?</h4>
                                    <a class="txt" href="https://pixelstrap.freshdesk.com/support/home">
                                        Chart with us here
                                    </a>
                                    <a class="btn btn-secondary" href="https://wa.me/+2348081411922">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 footer-copyright text-center">
                            <p class="mb-0">Copyright 2023 © Morhaulage </p>
                        </div>
                    </div>
                </div>
            </footer>
    ...
    <!-- latest jquery-->
    <script src="../admin_assets_dashboard/js/jquery-3.5.1.min.js"></script>
    <!-- Bootstrap js-->
    <script src="../admin_assets_dashboard/js/bootstrap/bootstrap.bundle.min.js"></script>
    <!-- feather icon js-->
    <script src="../admin_assets_dashboard/js/icons/feather-icon/feather.min.js"></script>
    <script src="../admin_assets_dashboard/js/icons/feather-icon/feather-icon.js"></script>
    <!-- scrollbar js-->
    <script src="../admin_assets_dashboard/js/scrollbar/simplebar.js"></script>
    <script src="../admin_assets_dashboard/js/scrollbar/custom.js"></script>
    <!-- Sidebar jquery-->
    <script src="../admin_assets_dashboard/js/config.js"></script>
    <!-- Plugins JS start-->
    <script src="../admin_assets_dashboard/js/sidebar-menu.js"></script>
    <script src="../admin_assets_dashboard/js/chart/knob/knob.min.js"></script>
    <script src="../admin_assets_dashboard/js/chart/knob/knob-chart.js"></script>
    <script src="../admin_assets_dashboard/js/chart/apex-chart/apex-chart.js"></script>
    <script src="../admin_assets_dashboard/js/chart/apex-chart/stock-prices.js"></script>
    <script src="../admin_assets_dashboard/js/notify/bootstrap-notify.min.js"></script>
    <script src="../admin_assets_dashboard/js/dashboard/default.js"></script>
    <script src="../admin_assets_dashboard/js/notify/index.js"></script>
    <script src="../admin_assets_dashboard/js/datepicker/date-picker/datepicker.js"></script>
    <script src="../admin_assets_dashboard/js/datepicker/date-picker/datepicker.en.js"></script>
    <script src="../admin_assets_dashboard/js/datepicker/date-picker/datepicker.custom.js"></script>
    <script src="../admin_assets_dashboard/js/photoswipe/photoswipe.min.js"></script>
    <script src="../admin_assets_dashboard/js/photoswipe/photoswipe-ui-default.min.js"></script>
    <script src="../admin_assets_dashboard/js/photoswipe/photoswipe.js"></script>
    <script src="../admin_assets_dashboard/js/typeahead/handlebars.js"></script>
    <script src="../admin_assets_dashboard/js/typeahead/typeahead.bundle.js"></script>
    <script src="../admin_assets_dashboard/js/typeahead/typeahead.custom.js"></script>
    <script src="../admin_assets_dashboard/js/typeahead-search/handlebars.js"></script>
    <script src="../admin_assets_dashboard/js/typeahead-search/typeahead-custom.js"></script>
    <script src="../admin_assets_dashboard/js/height-equal.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
    <script src="../admin_assets_dashboard/js/script.js"></script>
    <script src="../admin_assets_dashboard/js/theme-customizer/customizer.js"></script>
    <!-- login js-->
    <!-- Plugin used-->
